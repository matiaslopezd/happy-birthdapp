...
<script>
import { IonList, IonItem, IonAvatar, IonLabel, IonIcon, IonModal, IonInput, IonButton, IonPage, IonContent } from '@ionic/vue';
...
export default  {
  name: 'Contacts',
  components: {
    IonAvatar, IonList, IonItem, IonLabel, IonIcon, Modal, IonModal, IonInput, IonButton, IonPage, IonContent
  },
  setup() {
    return {
      call,
