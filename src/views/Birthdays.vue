...
<script>
import { IonList, IonItem, IonLabel, IonIcon, IonModal, IonButton, IonSelect, IonSelectOption, IonDatetime } from '@ionic/vue';
...
export default  {
  name: 'Gifts',
  components: {
    IonList, IonItem, IonLabel, IonIcon, Modal, IonModal, IonButton, IonSelect, IonSelectOption, IonDatetime
  },
  setup() {
    return {
      call,
