...
<script>
import { IonList, IonItem, IonAvatar, IonLabel, IonIcon, IonModal, IonInput, IonButton, IonTextarea, IonPage, IonContent } from '@ionic/vue';
...
export default  {
  name: 'Gifts',
  components: {
    IonAvatar, IonList, IonItem, IonLabel, IonIcon, Modal, IonModal, IonInput, IonButton, IonTextarea, IonPage, IonContent
  },
  setup() {
    return {
      call,
